...
import './Home.css';
import BackgroundImage from "./istockphoto-cover-letter.jpg"
...
const Home = () => {
  ...
  return (
    <div style={{minHeight:'100vh', minWidth:'100vw', backgroundColor: 'rgb(248, 232, 238)'}}>
      ...
      <div className="container">
        ...
        <div className="col-lg-6 col-md-6 col-sm-12 col-12 text-center mq" style={{height: '55%'}}>
            ...
            >
              ...
              <div className="text-center mb-2"><img className="rounded mt-5" src={logo}  style={{width:"35%",height:"35%", border: "5px solid #9505E3"}} alt="" /></div>
